...
SKKState::SKKState(SKKStateConfiguration* configuration, SKKEditorStack* editor, SKKCandidateWindow* window)
    : configuration_(configuration),
      editor_(editor),
      window_(window),
      completer_(&composingEditor_),
      selector_(&candidateEditor_, window_) {}
